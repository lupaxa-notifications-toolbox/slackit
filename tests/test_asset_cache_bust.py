...
def test_extra_asset_paths_strips_queries_and_dict_javascript() -> None:
...
def test_apply_asset_version_rewrites_relative_extra_assets_only() -> None:
    html = """
...
def test_apply_asset_version_replaces_an_existing_query() -> None:
